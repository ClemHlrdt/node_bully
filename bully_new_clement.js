...
Bully.election= function() {
	...
	console.log(Bully.connections[Bully.priority +1]);
	console.log('================================================', Bully.areYouThere());
	// console.log(Bully.connections[Bully.priority + 1].invoke('areYouThere', function(error, res, more) {
	// 	return res;
	// }));
	...
	for(var i = 0; i<restOfElements.length; i += 1){
		...
		try {
			...
			// Bully.connections[Bully.priority+1].areYouThere();
			if (Bully.connections[Bully.priority + 1 + i].invoke('areYouThere', function(error, res, more) {
				return res;
			}) == undefined) {
				throw error;
			}
